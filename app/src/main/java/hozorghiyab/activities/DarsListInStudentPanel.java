...
public class DarsListInStudentPanel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vaziyat_darsi_akhlaghi_in_student_panel);
        ...
        sharedPreferences = DarsListInStudentPanel.this.getSharedPreferences("file", DarsListInStudentPanel.this.MODE_PRIVATE);
        final String usernameStudent = sharedPreferences.getString("user", "");


        rModelsYouHaveKnow = new ArrayList<>();
        rAdapterYouHaveKnow = new RecyclerAdapterYouHaveKnow(rModelsYouHaveKnow,"dars_student_to_teacher_list",this,rAdapterYouHaveKnow,"",null,null,null,"");
